                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            ...
                            userMap.put("status","noactive");

                            mDatabase.setValue(userMap);

                            Intent startIntent = new Intent( RegisterActivity.this,DefaultDialogsActivity.class);
                            startActivity(startIntent);
                        }else{
                            Toast.makeText(RegisterActivity.this,"Tienes algunos errores",Toast.LENGTH_LONG);
                        }
                    }
                });
    }
